...
Subset of EGC's src/llm/paths.py — retains only the five functions needed
for session-data discovery. All git-subprocess logic removed; project_root()
falls back to Path.cwd() only.
"""
